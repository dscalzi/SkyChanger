...
public final class ReflectionUtil {
	...
	public static Class<?> getNMSClass(String localPackage){
		...
		if(nmsClasses.containsKey(localPackage)) return nmsClasses.get(localPackage);
    ...
    public static Class<?> getOCBClass(String localPackage) {
    	...
    	if(ocbClasses.containsKey(localPackage)) return ocbClasses.get(localPackage);
    ...
    public static Method getMethod(Class<?> clazz, String methodName, Class<?>... params) {
        if (!cachedMethods.containsKey(clazz)) cachedMethods.put(clazz, new HashMap<String, Method>());
